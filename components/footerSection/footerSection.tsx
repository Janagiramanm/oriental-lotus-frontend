                  ...
                  <div className={`col-md-12 text-start text-white text-center`}>
                      <div className={styles.footerLeft}>
                          ...
                          <ul className={`d-flex flex-row mb-3 justify-content-center align-items-center`}>
                              <li className={`px-2`}><a href={`https://www.facebook.com/OrientalLotusHospitalitySolutions`} target={"_blank"}><i className="bi bi-facebook"></i></a></li>
                              <li className={`px-2`}><a href={`https://www.linkedin.com/company/oriental-lotus-hospitality-solutions`} target={"_blank"}><i className="bi bi-linkedin"></i></a></li>
                              <li className={`px-2`}><a href={`https://www.instagram.com/olhsindia/`} target={"_blank"}><i className="bi bi-instagram"></i></a></li>
                              <li className={`px-2`}><a href={`https://twitter.com/OLHSIndia`} target={"_blank"}><i className="bi bi-twitter"></i></a></li>
                              <li className={`px-2`}><a href={`https://www.youtube.com/@OLHS`} target={"_blank"}><i className="bi bi-youtube"></i></a></li>
                          </ul>
                      </div>
